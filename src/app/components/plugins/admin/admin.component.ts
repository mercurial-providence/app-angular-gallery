...
export class AdminComponent implements OnInit {
  ...
  public logs:RawImportData<Logs> = new RawImportData<Logs>();
  ...
  ngOnInit() {
    this.dataService.getLogs<RawImportData<Logs>>('1', '999').subscribe(        
      (res: RawImportData<Logs>) => {
      if (res) {
        this.logs=res;
      }
    },
  ...
  checkPass(){
    ...
    if(getMD5(this.pass+'23LPOJ&(*QYWIDH(QIODOSA&WWD') == '5d6d870dded54216ff72137e93d704ec'){
      this.locked=false;
    }
  }
